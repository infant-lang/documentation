...
In the ASCII table, the numbers, characters, symbols as we know them, are assigned to a number. This number can be passed to the print that prints the ASCII equivalent of the number.
...
The `char` keyword can only print the ASCII equivalent of the number 🔢. It cannot print the number itself.
